...
person.greeting = function () {
    alert(`Greetings! My name is ${this.name.firstName}`);
};
...
/* STEP 4: Add a more complicated function to the object that describes the person, their age, gender, 
    ...
    person.describe = function () {
        return `Name: ${this.name.firstName} ${this.name.lastName}\nAge: ${this.age}\nGender: ${this.gender}\nInterests: ${this.interests.join(', ')}`;
    };
...
person.greeting = function () {
    alert(`Greetings! My name is ${this.name.firstName} ${this.name.lastName}`);
};
...
//Testing
person.greeting(); // Greetings! My name is Harman Sahni
output.textContent = person.bio();
person1.hello(); // This is P1
person2.hello(); // This is P2
